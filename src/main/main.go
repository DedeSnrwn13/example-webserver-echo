...
func hello(c echo.Context) error {
	return c.String(http.StatusOK, "hello form teh web side!")
}
...
func getCats(c echo.Context) error {
	...
	return c.JSON(http.StatusBadRequest, map[string]string{
		"error": "you need to lets us know if you went json or string data",
	})
}
...
func addCat(c echo.Context) error {
	...
	if err != nil {
		log.Printf("Failed reading the request body fot addCat: %s", err)
...
func main() {
	...
	g.Use(middleware.BasicAuth(func(username, password string, c echo.Context) (bool, error) {
		if username == "test" && password == "ting" {
			return true, nil
		}
